...
/var/lib/neo4j/bin/neo4j-admin import --database=${NEO4J_DB} ${META_NODE_CMD} ${NEURON_NODE_CMD} ${NEURON_REL_CMD} ${SYNSET_NODE_CMD} ${SYNSET_REL_CMD} ${SYNAPSE_NODE_CMD} ${SYNAPSE_REL_CMD} ${MITO_NODE_CMD} ${MITOSET_NODE_CMD} ${MITO_REL_CMD} ${MITOSET_REL_CMD} ${MITOSYNSET_REL_CMD}
