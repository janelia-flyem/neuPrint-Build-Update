...
#EXPORT_DIR=/mb6
EXPORT_BASE_DIR=/groups/flyem/data/neuprint_exports/vnc_flyem/syn_vnc_v1a
EXPORT_DIR=/neuprint_imports_csv_${UUID}_vnc
#EXPORT_DIR=/neuprint_imports_csv_20631_v1.1

NEO4J_DIR=/neo4j
IMPORT_BASE_DIR=/neo4j/import

NEO4J_DB=vnc${UUID}-3.db
...
#SYNSET_REL_CMD="--relationships=ConnectsTo=import/Neuprint_SynapseSet_to_SynapseSet_${UUID}.csv"
...
#/var/lib/neo4j/bin/neo4j-admin import --database=${NEO4J_DB} ${META_NODE_CMD} ${NEURON_NODE_CMD} ${NEURON_REL_CMD}
...
#echo "................"
#date
#cat /opt/neo4j-scripts/index-vnc.cypher | sudo -u neo4j ./bin/cypher-shell -u neo4j -p n304jT35t --format plain
#date
#echo "warmup cache"
#echo "................"
#date
