...
#EXPORT_DIR=/mb6
EXPORT_BASE_DIR=/groups/flyem/data/neuprint_exports/abg_flyem/syn_abg_v1a
EXPORT_DIR=/neuprint_imports_csv_${UUID}_abg
#EXPORT_DIR=/neuprint_imports_csv_20631_v1.1

NEO4J_DIR=/opt/neo4j
IMPORT_BASE_DIR=/opt/neo4j/import

NEO4J_DB=${UUID}_fabg.db
...
#echo "................"
#date
#cat /opt/neo4j-scripts/index-abg.cypher | sudo -u neo4j ./bin/cypher-shell -u neo4j -p n304jT35t --format plain
#date
#echo "warmup cache"
#echo "................"
#date
