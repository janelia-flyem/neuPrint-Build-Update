...
#EXPORT_DIR=/mb6
EXPORT_BASE_DIR=/groups/flyem/data/neuprint_exports/clio/medulla-sample-28c
...
#echo "................"
#date
#cat /opt/neo4j-scripts/index-med28c.cypher | sudo -u neo4j ./bin/cypher-shell -u neo4j -p n304jT35t --format plain
#date
#echo "warmup cache"
#echo "................"
#date
