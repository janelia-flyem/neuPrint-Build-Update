...
NEO4J_DB=${UUID}_1_1.db

META_NODE_CMD="--nodes=import/Neuprint_Meta_${UUID}.csv"

MITO_NODE_CMD="--nodes=import/Neuprint_Mitochondria_${UUID}.csv"
MITOSET_NODE_CMD="--nodes=import/Neuprint_MitochondriaSet_${UUID}.csv"
MITO_REL_CMD="--relationships:ConnectsTo=import/Neuprint_Neuron_to_MitochondriaSet_${UUID}.csv"
MITOSET_REL_CMD="--relationships:ConnectsTo=import/Neuprint_MitochondriaSet_to_Mitochondria_${UUID}.csv"
...
# sudo -s -u neo4j ./bin/neo4j-admin import --database=${NEO4J_DB} ${META_NODE_CMD} ${NEURON_NODE_CMD} ${NEURON_REL_CMD} ${SYNSET_NODE_CMD} ${SYNSET_REL_CMD} ${SYNAPSE_NODE_CMD} ${SYNAPSE_REL_CMD} ${MITO_NODE_CMD} ${MITOSET_NODE_CMD} ${MITO_REL_CMD} ${MITOSET_REL_CMD}
date
#echo "................"
#echo "clean copy"
#echo "................"
