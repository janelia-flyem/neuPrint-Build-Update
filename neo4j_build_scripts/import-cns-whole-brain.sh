...
#EXPORT_DIR=/mb6
EXPORT_BASE_DIR=/groups/flyem/data/neuprint_exports/male_whole_brain/syn_cns_v1a
EXPORT_DIR=/neuprint_imports_csv_${UUID}_cns
#EXPORT_DIR=/neuprint_imports_csv_20631_v1.1

NEO4J_DIR=/neo4j
IMPORT_BASE_DIR=/neo4j/import

NEO4J_DB=${UUID}_cns.db
...
#echo "................"
#date
#cat /opt/neo4j-scripts/index-cns.cypher | sudo -u neo4j ./bin/cypher-shell -u neo4j -p n304jT35t --format plain
#date
#echo "warmup cache"
#echo "................"
#date
